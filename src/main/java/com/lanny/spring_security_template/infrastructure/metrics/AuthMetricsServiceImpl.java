...
/**
 * Implementation of {@link AuthMetricsService} using Micrometer for Prometheus metrics exposure.
 *
 * <p>
 * Each metric is a labeled counter incremented on specific authentication or authorization events.
 * </p>
 *
 * <p>
...
public class AuthMetricsServiceImpl implements AuthMetricsService {
    ...
    @Override public void recordLoginSuccess() { loginSuccess.increment(); }
    @Override public void recordLoginFailure() { loginFailure.increment(); }
    @Override public void recordTokenRefresh() { refresh.increment(); }
    @Override public void recordUserRegistration() { registration.increment(); }
    @Override public void recordBruteForceDetected() { bruteForce.increment(); }
    @Override public void recordSessionRevoked() { sessionRevoked.increment(); }
    @Override public void recordRotationFailed() { rotationFailed.increment(); }
    @Override public void recordUserLocked() { userLocked.increment(); }
    @Override public void recordRefreshReused() { refreshReused.increment(); }
}
