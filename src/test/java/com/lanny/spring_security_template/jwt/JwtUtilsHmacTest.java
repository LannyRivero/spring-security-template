...
/**
 * ✅ Integration test: validates JWT creation and verification using HS256 (HMAC)
 * with a randomly generated 256-bit secret.
 *
 * This test complements JwtUtilsTest (RS256) by covering the symmetric
 * algorithm variant. It ensures HMAC tokens can be securely generated
 * and verified without relying on external configuration.
 */
